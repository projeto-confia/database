...
BEGIN
	...
	where detectenv.social_media_account.id_social_media_account = detectenv.post.id_social_media_account and detectenv.post.id_news = id_searched_news and detectenv.social_media_account.id_owner is null;
